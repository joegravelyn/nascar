...
def get_flag_data(url_header: str, series_id: int, race_id: int, sql_engine: Engine, load_to_sql: bool = True) -> tuple[bool, pd.DataFrame]:
   ...
   if api_result[0]:
      ...
      if load_to_sql:
         exist_df = pd
         df.to_sql("flag_data", con=sql_engine, if_exists="append", index=False)
