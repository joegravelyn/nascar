...
import pandas as pd
from .schedule_logic import clean_df

def get_schedule(url_header: str, year: int, series_id: int, sql_engine: Engine, load_to_sql: bool = True) -> tuple[bool, pd.DataFrame]:
   ...
   if api_result[0]:
      ...
      print(f"API call failed for Feeds.Schedule. URL response code = {api_result[1]}")
